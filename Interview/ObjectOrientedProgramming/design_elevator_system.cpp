...
*
* Analyze:
* Generic steps that you can follow:
*
*    Gather requirements
...
* 
* Reference: 
*  1. https://codereview.stackexchange.com/questions/232502/elevator-design-implementation-in-c
*  2. https://github.com/hannahvoelker/Elevator/blob/master/elevator.cpp
*  3. https://www.careercup.com/question?id=1808669
*  4. https://leetcode.com/discuss/interview-question/object-oriented-design/124927/Write-elevator-program-using-event-driven-programming
*
*  5. https://www.quora.com/What-is-the-best-answer-to-Design-an-elevator-system
*  6. https://leetcode.com/discuss/interview-question/124660/design-an-Elevator
*  7. http://www.cs.csi.cuny.edu/~natacha/TeachS_10/CSC330/Hws/Hw1.pdf
*  8. https://codereview.stackexchange.com/questions/5723/oop-elevator-design-evaluation?rq=1
*
*
* Key:
...
class SuperUser : public Clients { 
    public: 
    void printType() { 
